...
func (r *NegotiationRequest) WriteTo(w io.Writer) (int64, error) {
	...
	slog.Debug("Sent NegotiationRequest", "ver", r.Ver, "nmethods", r.NMethods, "methods", r.Methods)
	return int64(i), nil
}
...
func NewNegotiationReplyFrom(r io.Reader) (*NegotiationReply, error) {
	...
	slog.Debug("Got NegotiationReply", "ver", bb[0], "method", bb[1])
...
func (r *UserPassNegotiationRequest) WriteTo(w io.Writer) (int64, error) {
	...
	slog.Debug("Sent UserPassNegotiationRequest", "ver", r.Ver, "ulen", r.Ulen, "uname", r.Uname, "plen", r.Plen, "passwd", r.Passwd)
	return int64(i), nil
}
...
func NewUserPassNegotiationReplyFrom(r io.Reader) (*UserPassNegotiationReply, error) {
	...
	slog.Debug("Got UserPassNegotiationReply", "ver", bb[0], "status", bb[1])
...
func (r *Request) WriteTo(w io.Writer) (int64, error) {
	...
	slog.Debug("Sent Request", "ver", r.Ver, "cmd", r.Cmd, "rsv", r.Rsv, "atyp", r.Atyp, "dstaddr", r.DstAddr, "dstport", r.DstPort)
	return int64(i), nil
}
...
func NewReplyFrom(r io.Reader) (*Reply, error) {
	...
	slog.Debug("Got Reply", "ver", bb[0], "rep", bb[1], "rsv", bb[2], "atyp", bb[3], "bndaddr", addr, "bndport", port)
	return &Reply{
		Ver:     bb[0],
		Rep:     bb[1],
		Rsv:     bb[2],
