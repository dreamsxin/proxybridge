...
func (r *Request) Connect(w io.Writer, localAddr string) (net.Conn, error) {
	//slog.Info("Call:", "address", r.Address(), "localAddr", localAddr)
	rc, err := DialTCP("tcp", localAddr, r.Address())
	if err != nil {
		var p *Reply
