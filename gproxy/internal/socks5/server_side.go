...
func NewNegotiationRequestFrom(r io.Reader) (*NegotiationRequest, error) {
	slog.Debug("Got NewNegotiationRequestFrom")
	// memory strict
	bb := make([]byte, 2)
	...
	// 	return nil, err
	// }
	slog.Debug("Got NegotiationRequest", "ver", bb[0], "nmethods", bb[1])
	if bb[0] != Ver {
	...
	slog.Debug("Got NegotiationRequest", "ver", bb[0], "nmethods", bb[1], "methods", ms)
...
func (r *NegotiationReply) WriteTo(w io.Writer) (int64, error) {
	...
	slog.Debug("Sent NegotiationReply", "ver", r.Ver, "method", r.Method)
	return int64(i), nil
}
...
func NewUserPassNegotiationRequestFrom(r io.Reader) (*UserPassNegotiationRequest, error) {
	...
	slog.Debug("Got UserPassNegotiationRequest", "ver", bb[0], "ulen", bb[1], "uname", ub[:int(bb[1])], "plen", ub[int(bb[1])], "passwd", p)
...
func (r *UserPassNegotiationReply) WriteTo(w io.Writer) (int64, error) {
	...
	slog.Debug("Sent UserPassNegotiationReply", "ver", r.Ver, "status", r.Status)
	return int64(i), nil
}
...
func NewRequestFrom(r io.Reader) (*Request, error) {
	...
	if store.IsBlackSuffixes(string(addr)) {
		return nil, errors.New("black domain")
	}
	port := make([]byte, 2)
	if _, err := io.ReadFull(r, port); err != nil {
		return nil, err
	}
	slog.Debug("Got Request", "ver", bb[0], "cmd", bb[1], "rsv", bb[2], "atyp", bb[3], "dstaddr", addr, "dstport", port)
	return &Request{
		Ver:     bb[0],
		Cmd:     bb[1],
		Rsv:     bb[2],
...
func (r *Reply) WriteTo(w io.Writer) (int64, error) {
	...
	slog.Debug("Sent Reply", "ver", r.Ver, "rep", r.Rep, "rsv", r.Rsv, "atyp", r.Atyp, "bndaddr", r.BndAddr, "bndport", r.BndPort)
	return int64(i), nil
}
...
func NewDatagramFromBytes(bb []byte) (*Datagram, error) {
	...
	slog.Debug("Got Datagram", "rsv", d.Rsv, "frag", d.Frag, "atyp", d.Atyp, "dstaddr", d.DstAddr, "dstport", d.DstPort, "data", d.Data)
	return d, nil
}
